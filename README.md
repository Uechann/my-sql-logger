...
dependencies {
    implementation 'com.github.Uechann:my-sql-logger:v1.0.1'
}
```
...
| 버전 | Spring Boot | Java | 변경 내역 |
|---|---|---|---|
| v1.0.1 | 3.x | 17+ | TABLE 포맷 첫 줄 정렬 오류 수정 |
| v1.0.0 | 3.x | 17+ | 최초 릴리즈 |
...
1. GitHub에 코드 push
2. GitHub → **Releases** → **Create a new release** → 태그 `v1.0.1` 생성

...
public class ProxyConnection implements Connection {
    ...
    public ProxyConnection(Connection delegate, SqlLoggerProperties properties, SqlLogFormatter formatter) {
        this.delegate = delegate;
        this.properties = properties;
        this.formatter = formatter;
        this.connectionId = "conn-" + Integer.toHexString(System.identityHashCode(delegate));
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        PreparedStatement ps = delegate.prepareStatement(sql);
        return new ProxyPreparedStatement(ps, sql, properties, formatter, connectionId);
    }
